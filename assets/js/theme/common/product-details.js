    ...
    productOptionsChanged(event) {
        ...
        utils.api.productAttributes.optionChange(productId, $form.serialize(), 'products/bulk-discount-rates', (err, response) => {
            ...
            if(response.data.instock === false){
                $('[data-product-stock]').text('Out Of Stock');
                $('.form-field--stock').addClass('lowStockMessage');
                $('.form-field--stock').removeClass('inStockMessage');
            }
            if(response.data.instock === true){
                $('[data-product-stock]').text('In Stock');
                $('.form-field--stock').addClass('inStockMessage');
                $('.form-field--stock').removeClass('lowStockMessage');
            }*/
        });
    }
